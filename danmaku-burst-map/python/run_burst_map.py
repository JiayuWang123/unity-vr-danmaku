...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=True,
        help="Write layer-3 per-comment feature_danmaku outputs. Enabled by default.",
    )
    parser.add_argument(
        "--no-write-features",
        dest="write_features",
        action="store_false",
        help="Skip layer-3 feature_danmaku outputs.",
    )
...
def main() -> int:
    ...
    feature_rows = build_feature_rows(entries, density5, bursts) if args.write_features else []
